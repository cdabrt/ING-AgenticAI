...
export default function Home() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch("http://backend:8000/api/pipeline", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Intelligent document analysis and requirement extraction
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mb-12">
          ...
          {error && (
            <Card className="mb-8 border-red-500 w-full max-w-2xl shadow-lg">
          ...
          <div className="space-y-6 animate-in fade-in duration-500">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription className="mt-2">
                      <Badge variant="outline" className="bg-white dark:bg-black">{results.document_type}</Badge>
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
            ...
            <Card className="shadow-lg">
              <CardHeader className="bg-muted/50">
                <CardTitle className="text-lg">Business Requirements ({results.business_requirements.length})</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="shadow-lg">
              <CardHeader className="bg-muted/50">
                <CardTitle className="text-lg">Data Requirements ({results.data_requirements.length})</CardTitle>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
            ...
            {results.assumptions.length > 0 && (
              <Card className="shadow-lg">
                <CardHeader className="bg-muted/50">
                  <CardTitle className="text-lg">Assumptions ({results.assumptions.length})</CardTitle>
                </CardHeader>
                <CardContent>
